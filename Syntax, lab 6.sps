...
COMPUTE CHISQ=IDF.CHISQ(Pvalue,28).
EXECUTE.

* Chart Builder.
GGRAPH
  /GRAPHDATASET NAME="graphdataset" VARIABLES=MAH_1 MEANCI(CHISQ, 95)[name="MEAN_CHISQ" 
    LOW="MEAN_CHISQ_LOW" HIGH="MEAN_CHISQ_HIGH"] MISSING=LISTWISE REPORTMISSING=NO
  /GRAPHSPEC SOURCE=INLINE.
BEGIN GPL
  SOURCE: s=userSource(id("graphdataset"))
  DATA: MAH_1=col(source(s), name("MAH_1"))
  DATA: MEAN_CHISQ=col(source(s), name("MEAN_CHISQ"))
  DATA: LOW=col(source(s), name("MEAN_CHISQ_LOW"))
  DATA: HIGH=col(source(s), name("MEAN_CHISQ_HIGH"))
  GUIDE: axis(dim(1), label("Mahalanobis Distance"))
  GUIDE: axis(dim(2), label("Mean CHISQ"))
  GUIDE: text.title(label("Simple Error Bar Mean of CHISQ by Mahalanobis Distance"))
  GUIDE: text.footnote(label("Error Bars: 95% CI"))
  ELEMENT: point(position(MAH_1*MEAN_CHISQ))
  ELEMENT: interval(position(region.spread.range(MAH_1*(LOW+HIGH))), shape.interior(shape.ibeam))
END GPL.
...
save results /outfile= 'C:\Users\Martin.000\Documents\Martin\Forskning 200521\Statistik\Statistikkukrs VT20\Lab 6\screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'C:\Users\Martin.000\Documents\Martin\Forskning 200521\Statistik\Statistikkukrs VT20\Lab 6\screedata.sav'.
...
FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar25 ar26 ar27
...
FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar25 ar26 ar27 ar1 ar3 ar8 ar14 ar16 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar22 ar23 
    ar24 ar25 ar26 ar27 ar1 ar3 ar8 ar14 ar16 ar28
  /PRINT INITIAL EXTRACTION ROTATION FSCORE
...
FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar19 ar20 ar23 ar24 ar25 ar26 
    ar27 ar14
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar19 ar20 ar23 ar24 ar25 ar26 
    ar27 ar14
  /PRINT INITIAL EXTRACTION ROTATION FSCORE
  /CRITERIA FACTORS(2) ITERATE(25)
  /EXTRACTION PAF
...
FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar19 ar20 ar23 ar24 ar25 
    ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar19 ar20 ar23 ar24 ar25 
    ar26 ar27
  /PRINT INITIAL EXTRACTION ROTATION
  /CRITERIA FACTORS(2) ITERATE(25)
  /EXTRACTION PAF
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER A_research A_life.
